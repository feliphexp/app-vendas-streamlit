...
def gerar_pdf(nome_cliente, carrinho, total):
    ...
    for item, detalhes in carrinho.items():
        # Codifica o texto para ser compatível com a fonte do PDF
...
# Carrega os produtos para o estado da sessão, permitindo edições.
...
with col2:
    ...
    if not st.session_state.carrinho:
        ...
        total_pedido = 0
        # Usar list() para poder modificar o dicionário durante a iteração (ao remover itens)
